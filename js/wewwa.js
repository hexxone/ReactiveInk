...
wewwApp.AddMenu = (lang) => {
    ...
    if (proj.general.supportsaudioprocessing) {
        ...
        var td1 = ce("td");
        var td2 = ce("td");
        td1.innerHTML = "<br><h2>Audio Input</h2>";
    ...
    // footer with ident
    var footer = ce("div");
    footer.innerHTML = "<br><hr><h3 style='width:130px;text-align:left;display:block;margin:0 auto;'>[W]allpaper<br>[E]ngine<br>[W]eb<br>[W]allpaper<br>[A]dapter<br>by <a target=\"_blank\" href='https://hexxon.me'>Hexxon</a>";
    // finish up menu
    menu.append(preview, header, link, settings, preFoot, footer)
...
wewwApp.SetProperty = (prop, elm) => {
    ...
    if (!props[prop]) throw "SetProperty Error: invalid prop!";
